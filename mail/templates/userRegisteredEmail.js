const userRegisteredEmail = (
  ...
  return `<!DOCTYPE html>
    ...
    <div class="body">
        <p>Dear ${username},</p>
        <p>Welcome to KnowledgeHub, You have successfully registered on KnowledgeHub.</p>
        <p>Please update your profile and start exploring the platform.</p>
        <p> Get started by clicking the link below:</p>
        <p><a href="${profileLink}">Go To Dashboard</a></p>
